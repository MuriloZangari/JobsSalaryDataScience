...
This document presents the case study conducted for the Google Data Analytics Capstone. The case study follows the steps of the data analysis process: **ask, prepare, process, analyze, share,** and **act**.
...
The visualization below displays the number of times each unique value of `experience_level` appears in the data.
...
The salary incrementally rises as one progresses from the "Entry-level" to the "Senior" position. Interestingly, despite being a more senior position, the "Executive" role has a lower average salary than the "Senior" position. This unexpected result may be due to the disproportionate representation of the "Senior" position in the database, which appears nine times more frequently than the "Executive" position.
...
* It is worth noting that the average salary for medium-sized companies is better than that of large-sized companies. However, it is important to keep in mind that this plot does not take into account other factors such as the location of the company. Since the data has more entries from the United States, and this country has the highest average salary, the proportion of medium and large companies in the US might be masking this average.
...
## Scenario: Data Analysts profession in the United States
...
- The correlation between experience level and salary is significant. The average salary tends to increase with experience level. For example, professionals in "Machine Learning and AI" witness substantial salary increases ranging from 93k to 207k in the United States.

- The top 5 well-paid data-related jobs are "Machine Learning and AI," "Data Science and Research," "Data Engineering," and "Leadership and Management."
...
- The United States has the best salaries compared to other countries. Luxembourg, the United Kingdom, and Germany are the best countries to start a career as a Data Analyst.

- Work in person or remotely exhibits minimal impact on the average salary. For instance, an entry-level data analyst receives an average salary of 73k in person and 72k remotely. However, the dataset's limited representation of hybrid work settings warrants cautious interpretation.
